...
from transformers import AutoTokenizer, AutoModelForSeq2SeqLM, Seq2SeqTrainer, GenerationConfig, default_data_collator
...
parser = ArgumentParser(
    (TrainingArguments, DataTrainingArguments)
)
