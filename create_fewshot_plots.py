...
test_datasets = {"nli": ["scitail_text", "snli_text"],
                 "sent": ["sst5_text", "imdb_text"],
                 "cls": ["ag_news_text", "yahoo_text"]}

train_datasets = {"nli": ["origin_.?.", "mnli_text", "qnli_text", "mnli_text_qnli_text"],
                  "sent": ["origin_.?.", "sst2_text", "yelp_polarity_text", "sst2_text_yelp_polarity_text"],
                  "cls": ["origin_.?.", "dbpedia_text", "trec_coarse_text", "dbpedia_text_trec_coarse_text"]}

formating_map = {"origin_.?.":"random", "dbpedia_text":"DBPedia (SPoT)", "trec_coarse_text": "TREC Coarse (SPoT)", "dbpedia_text_trec_coarse_text": "DBPedia + TREC Coarse (Ours)",
                 "sst2_text":"SST2 (SPoT)", "yelp_polarity_text":"Yelp (SPoT)", "sst2_text_yelp_polarity_text": "SST2 + Yelp (Ours)",
                 "mnli_text": "MNLI (SPoT)", "qnli_text": "QNLI (SPoT)", "mnli_text_qnli_text": "MNLI + QNLI (Ours)",
                 "scitail_text": "SciTail", "snli_text": "SNLI", "sst5_text": "SST5", "imdb_text": "IMDB", "ag_news_text": "AG News", "yahoo_text": "Yahoo"}


n_classes = {"scitail_text": 2,
             "snli_text": 3,
             "sst5_text": 5,
             "imdb_text": 2,
             "ag_news_text": 4,
...
test_datasets = {"nli": ["scitail_text"],
                 "sent": ["imdb_text"],
                 "cls": ["ag_news_text"]}
