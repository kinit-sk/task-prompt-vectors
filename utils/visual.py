...
def create_heatmaps(data : Dict[str, List[List[float]]], filename_prefix: str = "", n_rows = 2) -> None:
    ...
    for name in data:
        ...
        plt.savefig(f"{save_dir}/{filename_prefix}_{name}_heatmap.png", bbox_inches="tight")
        plt.close()
